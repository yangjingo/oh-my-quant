...
<div class="engine">
  <div class="section-header"><h2>Metric Pages</h2><span class="count">7 metrics · definition + use case + chart</span></div>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1px;background:{C['hairline_dark']};border:1px solid {C['hairline_dark']};margin-bottom:48px">
    {' '.join(f'<a href="{slug}.html" style="background:{C['surface_card']};padding:16px 20px;text-decoration:none;color:{C['text_dark']};font-size:13px;font-weight:600;display:block">{name}<br><span style="font-size:11px;color:{C['muted_dark']};font-weight:400">{desc}</span></a>' for slug, name, desc in [("sharpe","Sharpe Ratio","primary"),("cumulative_return","Cumulative Return","primary"),("max_dd","Max Drawdown","最大回撤"),("annualized_volatility","Annualized Vol","年化波动"),("win_rate","Win Rate","胜率+盈亏比"),("profit","Profit Factor","盈亏效率"),("car_mdd","CAR/MDD","回撤调整"),("ulcer","Ulcer Index","压力指标"),("kline","K-line","量价走势")])}
  </div>

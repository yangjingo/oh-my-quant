...
1. [Aswath Damodaran — 估值教父](#aswath-damodaran)
2. [Benjamin Graham — 价值投资之父](#benjamin-graham)
3. [Bill Ackman — 激进投资者](#bill-ackman)
...
1. **任何资产都有价值** — 估值是连接"故事"与"数字"的桥梁
2. **估值非科学亦非艺术，而是手艺（Craft）** — 需要反复练习
3. **风险 = 不确定性 × 暴露程度** — 不是所有风险都需要规避
4. **成长只有在 ROIC > WACC 时才创造价值** — 盲目增长是毁灭性的
5. **宏观预测无意义** — 聚焦公司层面的现金流、增长和风险
...
1. **安全边际（Margin of Safety）** — 以远低于内在价值的价格买入（至少 50%）
2. **市场先生（Mr. Market）** — 市场是情绪化的伙伴，利用它而非被它左右
3. **投资 vs 投机** — 投资经过深入分析，保证本金安全并获取满意回报
4. **防御型 vs 进取型投资者** — 大多数人应做防御型、分散化、长期持有
5. **内在价值** — 基于资产、盈利、股息计算真实价值，无视市场价格波动
...
1. **集中投资** — 持有 10 个好生意，而非 100 个平庸的
2. **永久资本是超级武器** — 允许在波动中持有而不被迫卖出
3. **最好的非对称押注不是做空** — 是被错误定价的困境做多（如 GGP $0.34）
4. **避免会强制平仓的杠杆** — 组合必须能在任何 50% 回撤中存活
5. **个人纪律与财务纪律并行** — 健身/饮食/睡眠直接影响决策质量
...
1. **颠覆式创新是唯一真正的增长引擎** — 关注五大平台：DNA 测序、机器人、储能、AI、区块链
2. **无视基准指数** — 不做相对收益，只做绝对创新评分
3. **创新天然通缩** — 技术进步压低价格，美联储在打昨天的仗
4. **波动 = 机会** — 在恐慌中加仓，在狂热中保持警惕
5. **持有 25% 个人净资产于比特币** — 用真金白银兑现自己的信念
6. **AI 是史上最大的生产力提升** — 但 Nvidia 被高估，关注 AI 衍生标的
...
1. **多元思维模型** — 从数学、心理学、微观经济学等多学科获取分析框架
2. **能力圈** — 知道自己不知道什么，只在自己真正懂的领域下注
3. **少即是多** — 一生只需要几个好机会，集中投资于真正懂的东西
4. **避免愚蠢比追求聪明更重要** — 花一生避免自己的认知偏误
5. **以合理价格买好公司 > 以低价买平庸公司** — 改变了 Buffett 的投资方法
6. **分散在追求卓越时完全荒谬** — 持有少数优秀企业足够
7. **理性有界限** — 承认你不可能全知全能
...
> **注：** Burry 极其低调神秘，几乎不接受视频采访。大多数 YouTube 内容是对他公开信、持仓、13F 的分析和解读。
...
1. **独立研究，拒绝从众** — 自己读资产负债表和信用协议，不相信"共识正确"
2. **安全边际是生存前提** — 知道自己不会亏光时，就敢于承担集中度风险
3. **逆向 + 深度价值** — 在无人问津处寻找被严重错估的资产
4. **不对称下注** — 下行有限 + 上行巨大的赌注值得重仓
5. **警惕"这跟上次不一样"** — 这次大概率跟上次一样，泡沫永远循环
...
1. **Dhandho 框架：Heads I win, tails I don't lose much** — 非对称下注是核心
2. **克隆（Cloning）** — 通过 13F 文件复制顶尖投资者的最佳主意
3. **集中持有 5-10 只股票** — "Rule of 5"，不超过手指头数
4. **低换手率、长持有期** — 让复利完整发挥作用
5. **极低风险 + 极高不确定性** — 不确定性被高估，风险其实可控
6. **宁当模仿者，不当创新者** — 复制已验证的成功模式
7. **清单 + 心智模型** — 系统性避免重复犯错
...
1. **黑天鹅事件驱动一切** — 罕见高影响事件才是历史的推手
2. **反脆弱：不只是抗冲击，而是从冲击中获益** — 构建能从波动中成长的系统
3. **杠铃策略（Barbell Strategy）** — 90% 极度保守 + 10% 极度冒险，回避中间态
4. **尾部风险对冲** — 市场平静时买便宜的崩溃保险
5. **Fat Tails > 正态分布** — 真实世界是极端分布，不是钟形曲线
6. **Skin in the Game** — 没有切身利害的人无权提供建议
7. **预测是 BS** — 不要预测，直接构建能应对各种结局的投资组合
...
1. **买你懂的东西** — 从日常生活和消费体验中发现好股票
2. **别预测市场** — "试图预测回调亏掉的钱 > 回调中实际亏掉的钱"
3. **GARP：以合理价格买成长** — Growth at a Reasonable Price
4. **不被股价绑架判断** — "股票不会知道你拥有它"
5. **做功课** — 实地调研，了解公司基本面，不只是看股价
6. **长期持有** — 表现最好的股票都是持有 5-6 年以后才爆发
7. **剧烈波动是好事** — 前提是你了解自己持有的公司
8. **股市像扑克** — 即使打法完美也可能输，接受波动
...
1. **Scuttlebutt（闲聊调研法）** — 从客户、供应商、前员工、竞争对手获取一手信息
2. **15 点清单** — 研发效率、利润率、劳资关系、管理层诚信、长期增长前景
3. **买入 = 几乎永远不卖** — 如果买入前功课做对，正确的卖出时机几乎不存在
4. **关注品质而非价格** — 伟大公司配得上溢价估值
5. **管理层诚信不可谈判** — 不诚实的管理层一票否决
6. **有机增长 > 债务驱动收购** — 真正的需求扩张才可持续
7. **只有三个卖出理由**：买入时判断错了 / 基本面永久恶化 / 有显著更好的机会
...
| 标题 | 频道 | 说明 |
|------|------|------|
| [ET NOW Originals 系列（与宝莱坞明星对谈）](https://www.youtube.com/results?search_query=rakesh+jhunjhunwala+et+now+originals) | ET NOW | 与 Deepika/Nargis/Katrina/Shraddha 对话，深入浅出 |
| [CNBC TV18 重磅访谈 (2018)](https://www.youtube.com/results?search_query=rakesh+jhunjhunwala+cnbc+tv18+shereen+bhan) | CNBC TV18 | IL&FS 危机 + Nifty 10,000 = 底部 |
| [Moneycontrol: Big Deal 访谈](https://www.youtube.com/results?search_query=rakesh+jhunjhunwala+moneycontrol+big+deal) | Moneycontrol | PE 策略 + Titan/Nazara 案例 |
| [ET NOW: Nikunj Dalmia 对谈](https://www.youtube.com/results?search_query=rakesh+jhunjhunwala+nikunj+dalmia) | ET NOW | "我们正处经典大牛市的诞生" |
| [Zee Business: 纪念特辑](https://www.youtube.com/results?search_query=rakesh+jhunjhunwala+zee+business) | Zee Business | 生前老友 Madhu Kela 等人回忆 |
...
1. **永远投资印度** — "家里的饭这么好吃，为什么去外面吃？"
2. **买什么最重要，什么价格不重要** — 对的股票最终会证明价格是次要的
3. **耐心会被测试，但信念会被回报** — 用时间获取复利
4. **恐惧上帝、恐惧时间、恐惧你的梦想** — 他一直重复的人生哲学
5. **努力是我们的事，结果是上帝的事** — 对结果保持平和
6. **投资和交易就像妻子和情人** — 永远不要搞混
7. **即使只有 5 卢比也要投资** — 财富积累从零开始
...
1. **流动性是第一驱动力** — 央行和流动性决定市场方向，不是盈利预测
2. **集中重仓：有信念时大打出手** — Soros 教的："你叫它仓位？翻倍！"
3. **做空英镑一战成名** — 对抗固定汇率，赢家是看到系统脆弱性的人
4. **保持情绪空白，随时转向** — 错了就认，不要有 ego
5. **Soros 是最好的止损者** — 学会无痛退出，再正确的逻辑也有错误的时候
6. **逆共识被高估** — 共识大多数时候是对的
7. **宏观回来了** — 2026 年 Dollar bearish、Long Copper/Gold、Short Bonds、日本韩国看多
...
1. **能力圈（Circle of Competence）** — 只在你懂的领域下注
2. **护城河（Moat）** — 持久竞争优势比便宜价格重要得多
3. **长期持有** — 58 年只有 ~12 次真正重要的决策，大约 5 年一次
4. **不赚最后一个铜板** — 只在你可以理解的合理价位买入
5. **市场先生为你服务，不是指导你** — 情绪与投资必须分离
6. **永远不要做空美国** — 横跨几十年的主题
...
- [AI Hedge Fund 项目（GitHub）](https://github.com/virattt/ai-hedge-fund) — 灵感来源，13 位大师 Agent 的实现
- [awesome-trading-agents](https://github.com/LLMQuant/awesome-trading-agents) — AI 交易 Agent 生态全景
- [AI-Trader 论文](https://arxiv.org/abs/2512.10971) — 实时最小信息三大市场评测基准

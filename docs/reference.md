...
description: 量化金融资源索引 — Agent Skills、Python 库、AI Trading 平台、数据源、学习资料
---
...
| [AKShare](https://github.com/akfamily/akshare) | A 股 | 免费本地 Python 数据适配 |
| [Yahoo Finance / yfinance](https://github.com/ranaroussi/yfinance) | 全球 | 公开行情抓取 |

### 券商 / 交易执行

| Server | 覆盖 | 特点 |
|--------|------|------|
| [krakenfx/kraken-cli](https://github.com/krakenfx/kraken-cli) | 加密 | Kraken AI 原生 CLI |
| [okx/agent-trade-kit](https://github.com/okx/agent-trade-kit) | 加密 现货/永续/期货/期权 | OKX 官方 |
| [Interactive Brokers API](https://www.interactivebrokers.com/en/trading/ib-api.php) | 全球 | Interactive Brokers |
| [MetaTrader 5 Python](https://www.metatrader5.com/en/terminal/help/algotrading/python_metatrader5) | 外汇/期货 | MT5 Python 接口 |

### 研究 / 分析

| Server | 覆盖 | 特点 |
|--------|------|------|
| [TradingView](https://www.tradingview.com/) | 多市场 | 图表、筛选、指标 |
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 多市场 | 多 agent 研究工作流 |
...
| Server | 覆盖 | 特点 |
|--------|------|------|
| [whchien/ai-trader](https://github.com/whchien/ai-trader) | 多市场 | Backtrader + 数据桥接 |

---

### Financial Datasets 速记

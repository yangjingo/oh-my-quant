 ...
 * Used by Buffer.text/set/hline/vline/box.
 */
import type { Style } from "./buffer.ts";

// ── Core palette ──
export const GOLD = "#D4AF37";
export const GOLD_HL = "#E2BE4D";
...
// ── Style presets (pure data, no Buffer dependency) ──
...
export const S = {
  ...
  ruleGold:    { fg: GOLD, dim: true } as Style,
...
/** Pick the right color for a percentage change. */
